...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .item-donate { border-color: #ffd700; }
  .item-donate h4 { color: #ffd700; }
...
<body>
  ...
  <main class="main-content">
    ...
    <div class="footer">
      ...
      <p>Документ №SCP-RP-01 «ЗАСЛОН» | Версия 3.2 | Обновлено: сентябрь 2026</p>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .agreement-hidden.visible {
    display: block;
    animation: fadeInAgreement 0.5s ease;
  }
  @keyframes fadeInAgreement {
  ...
  .agreement-country.donate { border-left-color: #ffd700; }
  ...
  .agreement-country.donate h3 { color: #ffd700; }
  ...
  .agreement-country.donate ol li::before {
    color: #ffd700;
  }
  .agreement-footer {
    text-align: center;
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <!-- ПУНКТ "СОГЛАШЕНИЕ" УБРАН. Верни его сюда, когда захочешь. -->
  ...
  <main class="main-content">
    ...
    <div class="footer">
      <p>© 2026 MV.PROJECT | SCP FOUNDATION | MEDIUM ROLEPLAY</p>
      <p>Документ №SCP-RP-01 «ЗАСЛОН» | Версия 3.1 | Обновлено: сентябрь 2026</p>
      <p style="margin-top: 15px; color: #333;">CLASSIFIED — LEVEL 5 CLEARANCE REQUIRED</p>
    </div>

    <!-- СКРЫТОЕ СОГЛАШЕНИЕ (открывается только через меню, когда вернёшь пункт) -->
    <div class="agreement-hidden" id="agreement-block">
      <div class="agreement-section">
        ...
        <div class="agreement-country rf" id="agreement-rf">
          ...
          <ol>
            ...
            за действия Игроков, нарушающих законодательство Российской Федерации.</li>
            ...
            своё согласие на обработку персональных данных.</li>

            <li><strong>Юрисдикция.</strong> Все споры подлежат рассмотрению в соответствии 
        ...
        <div class="agreement-country rb" id="agreement-rb">
          ...
          <ol>
            <li><strong>Общие положения.</strong> Настоящее соглашение регулируется законодательством 
            Республики Беларусь, в том числе Законом «О персональных данных» от 07.05.2021 № 99-З.</li>

            <li><strong>Обработка персональных данных.</strong> Игрок даёт согласие на обработку 
            следующих данных: SteamID, IP-адрес, никнейм, история игровых действий.</li>

            <li><strong>Хранение данных.</strong> Персональные данные хранятся не более 3 лет 
            с момента последней активности Игрока.</li>
            ...
            <li><strong>Возрастные ограничения.</strong> Игрок подтверждает, что достиг возраста 
            13 лет, либо получил согласие законных представителей.</li>

            <li><strong>Ответственность.</strong> Администрация не несёт ответственности 
            ...
            для защиты персональных данных Игроков.</li>

            <li><strong>Изменение соглашения.</strong> Администрация вправе изменять условия. 
            Актуальная версия всегда доступна на сайте.</li>

            <li><strong>Юрисдикция.</strong> Все споры подлежат рассмотрению в соответствии 
            с законодательством Республики Беларусь.</li>
          </ol>
        </div>

        <!-- ДОНАТ -->
        <div class="agreement-country donate" id="agreement-donate">
          <h3><span class="flag-icon">💰</span> Раздел 3. Соглашение о донате (добровольном пожертвовании)</h3>

          <div class="alert alert-warning" style="margin-bottom: 20px;">
            <strong>💡 ВАЖНО:</strong> Донат — это <strong>добровольное пожертвование</strong> 
            на развитие проекта. Оно не является покупкой товара или услуги в юридическом смысле.
          </div>

          <ol>
            <li><strong>Добровольность.</strong> Все платежи на проекте <strong>MV.Project</strong> 
            являются <strong>добровольными пожертвованиями</strong> на развитие сервера, 
            оплату хостинга и поддержку проекта. Игрок перечисляет средства 
            <strong>по своей воле и без принуждения</strong>.</li>

            <li><strong>Привилегии.</strong> В благодарность за пожертвование Игрок получает 
            <strong>внутриигровые привилегии</strong>. Привилегии не являются товаром 
            и не подлежат обмену на реальные деньги.</li>

            <li><strong>Возврат средств.</strong> Возврат пожертвования возможен 
            <strong>в течение 14 (четырнадцати) календарных дней</strong> с момента оплаты. 
            Для возврата необходимо обратиться в Discord-сервер проекта. 
            <strong>По истечении 14 дней возврат средств не осуществляется.</strong></li>

            <li><strong>Условия возврата.</strong> Возврат производится только при условии, 
            что привилегии не были использованы (не активированы, не переданы другим лицам). 
            Администрация вправе отказать в возврате при подозрении на мошенничество.</li>

            <li><strong>Закрытие сервера.</strong> В случае закрытия проекта <strong>возврат 
            средств не производится</strong>. Однако администрация <strong>обязуется 
            перенести все привилегии</strong> на будущие серверы проекта (при их создании).</li>

            <li><strong>Снятие привилегий за нарушение правил.</strong> За нарушение правил проекта 
            администрация вправе <strong>снять привилегии</strong> без возврата средств. 
            Перед снятием администрация <strong>обязана вынести предупреждения</strong>.</li>

            <li><strong>Процедура снятия.</strong> Снятие привилегий происходит в следующем порядке:
              <ul>
                <li><strong>Первое нарушение</strong> — устное предупреждение.</li>
                <li><strong>Второе нарушение</strong> — письменное предупреждение + временное ограничение привилегий (от 3 до 7 дней).</li>
                <li><strong>Третье нарушение</strong> — полное снятие привилегий без возврата средств.</li>
              </ul>
            </li>

            <li><strong>Запрет на обмен и передачу.</strong> Привилегии не подлежат передаче 
            третьим лицам и не могут быть обменяны на реальные деньги.</li>

            <li><strong>Изменение условий доната.</strong> Администрация вправе изменять 
            условия предоставления привилегий и стоимость пожертвований. Изменения 
            не распространяются на уже полученные привилегии.</li>

            <li><strong>Ответственность сторон.</strong> Администрация не несёт ответственности 
            за технические сбои, повлёкшие временную потерю привилегий, если они произошли 
            по независящим от администрации причинам.</li>

            <li><strong>Согласие с условиями.</strong> Совершая пожертвование, Игрок 
            подтверждает, что ознакомлен с настоящим разделом и согласен с его условиями.</li>

            <li><strong>Налоги.</strong> Игрок самостоятельно несёт ответственность 
            за уплату налогов с перечисленных средств в соответствии с законодательством 
            своей страны (для РФ — НК РФ, для РБ — НК РБ).</li>
          </ol>
        </div>

        <!-- ОБЩИЕ УСЛОВИЯ -->
        <div class="agreement-country">
          <h3>🌐 Раздел 4. Общие условия для обеих стран</h3>
          <ol>
            ...
            противоречащего законодательству РФ и РБ.</li>
            ...
            <strong>Discord-сервер MV.Project</strong>.</li>

            <li><strong>Согласие на обработку данных.</strong> Регистрируясь на сервере, 
            Игрок автоматически принимает условия обеих частей соглашения.</li>

            <li><strong>Итоговое согласие.</strong> Совершая любое действие на сервере, 
            Игрок подтверждает полное согласие со всеми условиями.</li>
          </ol>
        </div>

        <div class="agreement-footer">
          <p>Дата последнего обновления соглашения: сентябрь 2026</p>
          <p>Версия документа: 2.0</p>
          <p style="margin-top:15px; color:#00ff88;">Все вопросы — через Discord-сервер проекта</p>
        </div>

        <button class="agreement-close" onclick="closeAgreement()">✕ ЗАКРЫТЬ СОГЛАШЕНИЕ</button>
      </div>
    </div>
  ...
  <script>
    ...
    // ОТКРЫТИЕ СОГЛАШЕНИЯ (кнопку убрали, но функция осталась — если вернёшь ссылку, всё заработает)
