...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-section">
        ...
        <div class="nav-sub">
          <a href="#" onclick="openAgreement(); return false;">Открыть соглашение</a>
        </div>
      </div>
  ...
  <main class="main-content">
    ...
    <div class="footer">
      ...
      <p>Документ №SCP-RP-01 «ЗАСЛОН» | Версия 3.0 | Обновлено: сентябрь 2026</p>
      <p style="margin-top: 15px; color: #333;">CLASSIFIED — LEVEL 5 CLEARANCE REQUIRED</p>
    </div>

    <!-- СКРЫТОЕ СОГЛАШЕНИЕ (открывается только через меню) -->
      ...
      <div class="agreement-section">
        ...
        <div class="agreement-country donate" id="agreement-donate">
          ...
          <ol>
            ...
            Перед снятием администрация <strong>обязана вынести предупреждения</strong> 
            (в соответствии с общим регламентом наказаний). При систематических нарушениях 
            привилегии снимаются без компенсации.</li>
        ...
        <div class="agreement-country">
          ...
          <ol>
            ...
            (вход, донат, общение), Игрок подтверждает полное согласие со всеми 
            условиями настоящего Соглашения.</li>
          </ol>
        </div>
  ...
  <script>
    ...
    function openAgreement() {
      ...
      // Плавная прокрутка к соглашению
      setTimeout(() => {
